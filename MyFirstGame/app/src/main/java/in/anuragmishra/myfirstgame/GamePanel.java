...
{
    public static final int WIDTH = 856;//since our image is of this size we are making size of screen as this
    public static final int HEIGHT = 480;
    public static final int MOVESPEED = -5;//this is the pace with which the game moves
    ...
    {
        super(context);//super here is the surfaceView
    ...
    public void surfaceCreated(SurfaceHolder holder){
        ...
        player = new Player(BitmapFactory.decodeResource(getResources(), R.drawable.dino), 44, 45, 6);
    ...
    //this method is for touch event on screen
    @Override
...
//            }
            ...
            if(missileElapsed >(2000 - player.getScore()/4)){
                ...
                if(missiles.size()==0)
                {
                    missiles.add(new Missile(BitmapFactory.decodeResource(getResources(),R.drawable.missile),WIDTH + 10, 400, 45, 15, player.getScore(), 13));
                }
                else
                {

                    missiles.add(new Missile(BitmapFactory.decodeResource(getResources(),R.drawable.missile),
                            WIDTH+10, 400,45,15, player.getScore(),13));
                }
    ...
    {
        final float scaleFactorX = getWidth()/(WIDTH*1.f);//this makes the background adjustable for any phone screen
